...
const translations = {
    es: {
        ...
        'feature-1-title': 'Estadísticas en Tiempo Real',
        'feature-1-desc': 'Visualiza el DPS de cada miembro de tu party instantáneamente durante el combate.',
        'feature-2-title': 'Interfaz Intuitiva',
        'feature-2-desc': 'Diseño limpio y fácil de usar que no interfiere con tu experiencia de juego.',
        'feature-3-title': 'Ultra Ligero',
        'feature-3-desc': 'Optimizado para no afectar el rendimiento del juego, consume mínimos recursos.',
        'feature-4-title': 'Copia Rápida',
        'feature-4-desc': 'Copia las estadísticas al portapapeles con un solo clic para compartir con tu guild.',
        'feature-5-title': 'Siempre Visible',
        'feature-5-desc': 'Modo "Always On Top" para mantener las estadísticas visibles sobre el juego.',
        'feature-6-title': 'Personalizable',
        'feature-6-desc': 'Ajusta la interfaz a tu gusto con opciones de personalización flexibles.',
        ...
        'download-note': 'Al descargar, aceptas que este es un proyecto de código abierto sin garantías.',
    ...
    pt: {
        ...
        // Features Section
        'features-title': 'Principais Características',
        'features-description': 'Tudo o que você precisa para dominar o combate em Albion Online',
        'feature-1-title': 'Estatísticas em Tempo Real',
        ...
        'feature-2-desc': 'Design limpo e fácil de usar que não interfere na sua experiência de jogo.',
        'feature-3-title': 'Ultra Leve',
        'feature-3-desc': 'Otimizado para não afetar o desempenho do jogo, consome recursos mínimos.',
        'feature-4-title': 'Cópia Rápida',
        'feature-4-desc': 'Copie as estatísticas para a área de transferência com um clique para compartilhar com sua guilda.',
        'feature-5-title': 'Sempre Visível',
        'feature-5-desc': 'Modo "Always On Top" para manter as estatísticas visíveis sobre o jogo.',
        'feature-6-title': 'Personalizável',
        'feature-6-desc': 'Ajuste a interface ao seu gosto com opções de personalização flexíveis.',
        ...
        'download-feature-3': 'Atualizações regulares',
        'download-btn': 'Baixar Agora',
        'download-btn-sub': 'Windows 10/11',
        'download-note': 'Ao baixar, você aceita que este é um projeto de código aberto sem garantias.',
